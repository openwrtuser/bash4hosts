...
sed -i -e -e '/^$/d' hosts1.txt
# Removing all commented lines
sed -i -e '/^#/d' hosts1.txt
...
# sed -i -e '1 i\0.0.0.0 0.0.0.0' myhosts
sed -i -e '1 i\255.255.255.255 broadcasthost' myhosts
sed -i -e '1 i\127.0.0.1 localhost' myhosts
